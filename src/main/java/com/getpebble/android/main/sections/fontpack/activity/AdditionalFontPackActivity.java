package com.getpebble.android.main.sections.fontpack.activity;
...
public class AdditionalFontPackActivity extends a {
    @TargetApi(21)
    ...
    public int a() {
        return R.layout.activity_additional_font_pack;
    }

    public int e() {
        return R.string.additional_font_pack;
    }
}

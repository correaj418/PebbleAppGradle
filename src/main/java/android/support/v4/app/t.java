                    ...
                    if (bVar2 != null) {
                        ...
                        if (a != null) {
                            ...
                            if (transition != null) {
                                ...
                                t.b(transition, arrayList4);
                            }
                        }
                    }
                    t.b(transition2, transition, arrayList4, true);
                    return true;
                }
            });
            a(transition, aVar);
        ...
        if (transition4 != null) {
            ...
            view.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public boolean onPreDraw() {
                    view3.getViewTreeObserver().removeOnPreDrawListener(this);
                    if (transition != null) {
                        t.a(transition, arrayList5);
                        t.b(transition, transition2, arrayList6, false);
                        t.b(transition, transition3, arrayList7, false);
                    }
                    if (transition2 != null) {
                        t.a(transition2, arrayList6);
                        t.b(transition2, transition, arrayList5, false);
                        t.b(transition2, transition3, arrayList7, false);
                    }
                    if (transition3 != null) {
                        t.a(transition3, arrayList7);
                    }

...
public class NestedScrollView extends FrameLayout implements ad, x, z {
    ...
    static class a extends android.support.v4.view.a {
        ...
        public void a(View view, c cVar) {
            super.a(view, cVar);
            NestedScrollView nestedScrollView = (NestedScrollView) view;
            cVar.a(ScrollView.class.getName());
            if (nestedScrollView.isEnabled()) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action & 255) {
            ...
            case 2:
                action = this.q;
                if (action != -1) {
                    int a = t.a(motionEvent, action);
                    if (a != -1) {
                        action = (int) t.d(motionEvent, a);
        ...
        switch (a) {
            ...
            case 1:
                if (this.j) {
                    ...
                    a = (int) af.b(velocityTracker, this.q);
                ...
                break;
            case 2:
                int a2 = t.a(motionEvent, this.q);
                if (a2 != -1) {
                    int i;
                    int d = (int) t.d(motionEvent, a2);
                    a = this.f - d;
                    ...
                    if (this.j) {
                        ...
                        if (!dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, this.r)) {
                            if (obj != null) {
                                ...
                                a = scrollY + i;
                                if (a < 0) {
                                    this.d.a(((float) i) / ((float) getHeight()), t.c(motionEvent, a2) / ((float) getWidth()));
                                    if (!this.e.a()) {
                                        this.e.c();
                                    }
                                } else if (a > scrollRange) {
                                    this.e.a(((float) i) / ((float) getHeight()), 1.0f - (t.c(motionEvent, a2) / ((float) getWidth())));
                                    if (!this.d.a()) {
                                        this.d.c();
                                    }
                                }
            ...
            case 5:
                a = t.b(motionEvent);
                this.f = (int) t.d(motionEvent, a);
                this.q = t.b(motionEvent, a);
                break;
            case 6:
                a(motionEvent);
                this.f = (int) t.d(motionEvent, t.a(motionEvent, this.q));
                break;
        }
        if (this.k != null) {
    ...
    private void a(MotionEvent motionEvent) {
        ...
        if (t.b(motionEvent, action) == this.q) {
            action = action == 0 ? 1 : 0;
            this.f = (int) t.d(motionEvent, action);
            this.q = t.b(motionEvent, action);
            if (this.k != null) {
                this.k.clear();
            }
        }

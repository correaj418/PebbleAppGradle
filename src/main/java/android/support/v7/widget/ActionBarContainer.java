...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        this.a = obtainStyledAttributes.getDrawable(k.ActionBar_background);
        this.b = obtainStyledAttributes.getDrawable(k.ActionBar_backgroundStacked);
        this.j = obtainStyledAttributes.getDimensionPixelSize(k.ActionBar_height, -1);
        if (getId() == f.split_action_bar) {
            this.d = true;
            this.c = obtainStyledAttributes.getDrawable(k.ActionBar_backgroundSplit);
        }

...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.b = obtainStyledAttributes.getResourceId(k.ViewStubCompat_android_inflatedId, -1);
        this.a = obtainStyledAttributes.getResourceId(k.ViewStubCompat_android_layout, 0);
